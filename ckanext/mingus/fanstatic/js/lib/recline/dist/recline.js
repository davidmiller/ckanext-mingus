...
my.Grid = Backbone.View.extend({
  ...
  template: ' \
    ...
    <table class="recline-grid table-striped table-condensed" cellspacing="0"> \
      <thead class="notfixed-header"> \
        <tr> \
          {{#fields}} \
            <th class="column-header {{#hidden}}hidden{{/hidden}}" data-field="{{id}}" notstyle="width: {{width}}px; max-width: {{width}}px; min-width: {{width}}px;" title="{{label}}"> \
              <span class="column-header-name">{{label}}</span> \
            </th> \
          {{/fields}} \
          <th class="last-header" notstyle="width: {{lastHeaderWidth}}px; max-width: {{lastHeaderWidth}}px; min-width: {{lastHeaderWidth}}px; padding: 0; margin: 0;"></th> \
        </tr> \
      </thead> \
      <tbody class="notscroll-content"></tbody> \
    </table> \
    </div> \
  ',
...
my.GridRow = Backbone.View.extend({
  ...
  template: ' \
      {{#cells}} \
      <td data-field="{{field}}" notstyle="width: {{width}}px; max-width: {{width}}px; min-width: {{width}}px;"> \
